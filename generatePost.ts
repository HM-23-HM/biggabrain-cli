...
import { stripLLMOutputMarkers } from "./src/utils/parse";
...
//   const htmlOutputPath = path.resolve(__dirname, "posts", "html", filename);
...
//   await page.goto(
//     "file://" + path.resolve(__dirname, "posts", "html", htmlFilename)
//   );
...
//   const htmlFilesPath = path.resolve(__dirname, "posts", "html");
...
//   await generateImagesForSources(motivationalQuotes, "Motivational Quote");
//   await generateImagesForSources(quizzes, "Quizzes");
//   await generateImagesForSources(examTips, "Exam Tips");
...
const getJsArray = (input: string): string[] => {
    // console.log({ input, stripped: stripLLMOutputMarkers(input) })
